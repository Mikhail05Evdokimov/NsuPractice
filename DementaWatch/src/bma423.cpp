...
void MyWatch::AccSensor_Interface_Init()
{
...
bool MyWatch::CheckAccSensor()
{
}

void MyWatch::AccSensor_Updata(uint32_t millis, uint32_t time_ms)
{
...
void MyWatch::AccSensor_OnStep(bool Step, bool Reset)
{
}

void MyWatch::AccSensor_Sleep(bool Acc, bool Step)
{
}

void MyWatch::AccSensor_GetStepValue(int32_t *val)
{
}

float MyWatch::AccSensor_GetX() { return AccX; }
float MyWatch::AccSensor_GetY() { return AccY; }
float MyWatch::AccSensor_GetZ() { return AccZ; }

uint32_t MyWatch::AccSensor_GetStep() { return stepCount; }
